        ...
        <div className="confirm-order">
         ...
         <div className="row d-flex justify-content-between">
            <div className="col-12 col-lg-8 mt-5 order-confirm">
                ...
                <p className="mb-4"><b>Address:</b> {`${shippingInfo.address}, ${shippingInfo.city}, ${shippingInfo.popularBusStop}, ${shippingInfo.state}`}</p>
			...
			<div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <p>Shipping: <span className="order-summary-values">${deliveryPrice}</span></p>
